...
const DEFAULT_WORDS = [
  ...
  },
  {
    ...
    dir: "rtl",
    text: "مرحبا",
    font: 'Noto Naskh Arabic, "Amiri", "Scheherazade", serif',
  },
  {
    label: "فارسی",
    lang: "fa",
  ...
  },
  {
    ...
    dir: "rtl",
    text: "שלום",
    font: '"Rubik","Noto Sans Hebrew", Noto Sans, system-ui, sans-serif',
  },
  {
    label: "हिन्दी",
    lang: "hi",
    dir: "ltr",
    text: "नमस्ते",
    font: 'Noto Serif Devanagari, "Kohinoor Devanagari", serif',
  },
  {
    label: "বাংলা",
    lang: "bn",
    dir: "ltr",
    text: "নমস্কার",
    font: 'Noto Serif Bengali, "Noto Sans Bengali", serif',
  },
  {
    label: "中文（简体）",
    lang: "zh-CN",
    dir: "ltr",
    text: "你好",
    font: 'Noto Sans, "PingFang SC","Microsoft YaHei", sans-serif',
  },
  {
    label: "日本語",
    lang: "ja",
